...
* TODO doom-modeline
не надо
[[https://github.com/seagle0128/doom-modeline/issues/207][seagle0128/doom-modeline#207 Modifying evil-state color.]]
#+begin_src emacs-lisp :lexical t :tangle no
...
#+end_src
** jmt-mode
Бесполезно если есть treesitter. 
#+begin_src emacs-lisp :lexical t :tangle no
(use-package jmt-mode
    :config
  (autoload 'jmt-mode "jmt-mode" nil t)
  (setq auto-mode-alist (cons (cons "\\.java\\'" 'jmt-mode) auto-mode-alist))
