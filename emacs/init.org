...
* dap-mode
var "lsp-java/eclipse.jdt.ls/test-runner/junit-platform-console-standalone.jar"
#+begin_src emacs-lisp :lexical t
...

("⚑" "⬆" "■")
    <--- [[https://github.com/karthink/popper][GitHub - karthink/popper: Emacs minor-mode to summon and dismiss buffers easi...]]
#+begin_src  emacs-lisp :lexical t
...
* org-id
:PROPERTIES:
:ID:       ddc98e84-959e-486e-856c-2dfe355dd0d8
:END:
...
#+end_src
* TODO xref
[[https://github.com/jiegec/emacs.d/blob/35af3f66947e5cfa6879b46d65de1f229802d845/lisp/init-utils.el#L37]]
#+begin_src emacs-lisp :lexical t
(use-feature xref
;    :bind
;   ;; Mimic VSCode
