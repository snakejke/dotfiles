...
(setq +literate-config-file (file-truename "~/OrgFiles/config.org"))
...
(doom! :input
       ...
       ;;ivy
       (corfu +orderless)                                 ; a search engine for love and life
       ...
       (default +bindings +smartparens))
        ;; все что ниже я увидел у чела
        ;; https://github.com/ronisbr/doom.d/blob/bd5fbaf32ff41ae7850c4e0f88a9fd1756eb1951/init.el
        ;; Make evil respect visual lines.
        ;; вроде хуево. не понимаю.
